...
DocumentReference? get currentUserReference =>
    loggedIn ? QuickTalkRecord.collection.doc(currentUser!.uid) : null;

QuickTalkRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : QuickTalkRecord.getDocument(QuickTalkRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
